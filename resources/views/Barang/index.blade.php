						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="barang/edit/{{$barang->id}}"><i class="fa fa-edit">Edit</i> </a>
										<a href="barang/delete/{{$barang->id}}"><i class="fa fa-trash">Delete</i> </a>
									</td>
								</tr>
								@endforeach
							</tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form method="POST" action="{{url('barang/add')}}">
        	@csrf()
